...
module.exports = React.createClass({
    render: function() {
        var icons = {
            ...
            logout: <svg version='1.2' xmlns='http://www.w3.org/2000/svg' viewBox='-70 -70 652 652' fill='currentColor' height='24' width='24'><path d="M256 0c-141.385 0-256 114.615-256 256s114.615 256 256 256 256-114.615 256-256-114.615-256-256-256zM256 464c-114.875 0-208-93.125-208-208s93.125-208 208-208 208 93.125 208 208-93.125 208-208 208z"/><path d="M336 128l-80 80-80-80-48 48 80 80-80 80 48 48 80-80 80 80 48-48-80-80 80-80z"/></svg>
        };
